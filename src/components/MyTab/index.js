...
const MyTab = () => {
    return (
        <Tabs.Navigator>
          <Tabs.Screen name="Trang chủ" component={Home} options={{ headerShown: false,
       ...
       <Tabs.Screen name="Danh sách đăng ký" component={MyListings} options={{ headerShown: false,
           tabBarIcon: ({ focused, color }) => (
        <Image
...
<Tabs.Screen name="Hồ sơ" component={Profile} options={{ headerShown: false,
           tabBarIcon: ({ focused, color }) => (
        <Image
